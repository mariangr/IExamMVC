...
namespace IExam.Controllers
{
    ...
    {
        private VideoCommentsEntities db = new VideoCommentsEntities();
        ...
        public ActionResult Create([Bind(Include="ID,message,link")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="ID,message,link")] Comment comment)
        {
            if (ModelState.IsValid)
            {
